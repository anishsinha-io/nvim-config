...
return {
  ...
  -- Add Go & related to treesitter
  {
    ...
    opts = function(_, opts)
      if type(opts.ensure_installed) == "table" then
        M.list_insert_unique(opts.ensure_installed, { "go", "gomod", "gosum", "gowork" })
      end
    end,
  },
  ...
  -- Ensure Go LSP, linter, and imports reviser are installed
  {
    ...
    opts = function(_, opts)
      if type(opts.ensure_installed) == "table" then
        M.list_insert_unique(opts.ensure_installed, "goimports-reviser")
      end
    end,
  },

  {
    ...
    opts = function(_, opts)
      if type(opts.ensure_installed) == "table" then
        M.list_insert_unique(opts.ensure_installed, { "gomodifytags", "gofumpt", "iferr", "impl" })
      end
    end,
  },

  {
    ...
    dependencies = {
      "mfussenegger/nvim-dap",
      {
        ...
        opts = function(_, opts)
          if type(opts.ensure_installed) == "table" then
            M.list_insert_unique(opts.ensure_installed, "delve")
          end
        end,
      },
    },
